...
! used by sw_trans_chl expanded in bldepth, modified by zengyh 2018-11-01:
   integer (int_kind), public, dimension(nx_block,ny_block,max_blocks_clinic) :: &
     CHLINDX       ! chlorophyll index from table

! used by sw_trans_chl expanded in bldepth, modified by zengyh 2018-11-01:
   real (r8), public, dimension(0:ksol,0:nsub) :: & 
