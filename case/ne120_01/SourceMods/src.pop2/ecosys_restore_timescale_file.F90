...
subroutine file_init(this, nml_filename, nml_in)
  ...
  !  input variables
  !-----------------------------------------------------------------------
  type(ecosys_restore_timescale_file_type) :: this
  ...
  !-----------------------------------------------------------------------
  call read_namelist(this,nml_filename, nml_in, file_name, file_format)
  call read_restoring_timescale_from_file(this,file_name, file_format)
