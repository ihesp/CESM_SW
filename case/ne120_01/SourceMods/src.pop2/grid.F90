...
! public needed by vmix_kpp.F90 and set by zengyh 2019-01-08:
   real (POP_r8), public, dimension (nx_block,ny_block,max_blocks_clinic) :: &
      AU0,AUN,AUE,AUNE,AT0,ATS,ATW,ATSW
