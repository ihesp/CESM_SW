...
real(r8) :: cldt_permute           (pver,pcols) 
real(r8) :: cldc_permute           (pver,pcols)   
real(r8) :: cmfdqr_permute         (pver,pcols)   
real(r8) :: evapc_permute          (pver,pcols) 
real(r8) :: conicw_permute         (pver,pcols)   
real(r8) :: cwat_permute           (pver,pcols)   
real(r8) :: precs_permute          (pver,pcols)   
real(r8) :: conds_permute          (pver,pcols)   
real(r8) :: evaps_permute          (pver,pcols)   
real(r8) :: cldvcu_permute         (pver,pcols)  
real(r8) :: cldvst_permute         (pver,pcols) 
real(r8) :: dlf_permute            (pver,pcols) 
real(r8) :: tracer_permute         (pver,pcols)  
real(r8) :: scavcoef_permute       (pver,pcols)     
real(r8) :: qqcw_permute           (pver,pcols)          
real(r8) :: f_act_conv_permute     (pver,pcols)                
real(r8) :: sol_factic_in_permute  (pver,pcols)   
! out
real(r8) :: scavt_permute          (pver,pcols)     
real(r8) :: iscavt_permute         (pver,pcols)      
real(r8) :: fracis_permute         (pver,pcols)         
real(r8) :: icscavt_permute        (pver,pcols)          
real(r8) :: isscavt_permute        (pver,pcols)          
real(r8) :: bcscavt_permute        (pver,pcols)          
real(r8) :: bsscavt_permute        (pver,pcols)          

type wetdepa_v2_args
    integer :: version
    integer :: ncol
    integer :: pcols
    integer :: pver
    ...
    integer(8) :: tracer        
    integer(8) :: scavcoef      
    integer(8) :: sol_factic_in 
    integer(8) :: qqcw          
    integer(8) :: f_act_conv    
    ! out
    integer(8) :: scavt         
    integer(8) :: iscavt        
    integer(8) :: fracis        
...
type transpose_args
    ...
    integer(8) :: p_permute            
    integer(8) :: q_permute            
    integer(8) :: pdel_permute         
    integer(8) :: cldt_permute         
    integer(8) :: cldc_permute         
    integer(8) :: cmfdqr_permute       
    integer(8) :: evapc_permute        
    integer(8) :: conicw_permute       
    integer(8) :: cwat_permute         
    integer(8) :: precs_permute        
    integer(8) :: conds_permute        
    integer(8) :: evaps_permute        
    integer(8) :: cldvcu_permute       
    integer(8) :: cldvst_permute       
    integer(8) :: dlf_permute          
    integer(8) :: tracer_permute       
    integer(8) :: scavcoef_permute     
    integer(8) :: sol_factic_in_permute
    integer(8) :: qqcw_permute         
    integer(8) :: f_act_conv_permute   
    integer(8) :: scavt_permute        
    integer(8) :: iscavt_permute       
    integer(8) :: fracis_permute       
    integer(8) :: icscavt_permute      
    integer(8) :: isscavt_permute      
    integer(8) :: bcscavt_permute      
    integer(8) :: bsscavt_permute      
end type
type(wetdepa_v2_args) :: wetdepa_v2_para
type(transpose_args) :: transpose_para
integer, external :: slave_wetdepa_v2_parallel
integer, external :: slave_transpose_parallel

wetdepa_v2_para%gravit                   = gravit
wetdepa_v2_para%ncol                     = ncol                    
wetdepa_v2_para%pcols                    = pcols                 
wetdepa_v2_para%pver                     = pver                     
wetdepa_v2_para%is_strat_cloudborne      = is_strat_cloudborne         
wetdepa_v2_para%deltat                   = deltat                  
wetdepa_v2_para%sol_fact                 = sol_fact                   
wetdepa_v2_para%sol_facti_in             = sol_facti_in                     
wetdepa_v2_para%p                        = loc(p_permute             (:,:))                 
wetdepa_v2_para%q                        = loc(q_permute             (:,:))                 
wetdepa_v2_para%pdel                     = loc(pdel_permute          (:,:))                 
wetdepa_v2_para%cldt                     = loc(cldt_permute          (:,:))                 
wetdepa_v2_para%cldc                     = loc(cldc_permute          (:,:))                 
wetdepa_v2_para%cmfdqr                   = loc(cmfdqr_permute        (:,:))                 
wetdepa_v2_para%evapc                    = loc(evapc_permute         (:,:))                 
wetdepa_v2_para%conicw                   = loc(conicw_permute        (:,:))                 
wetdepa_v2_para%cwat                     = loc(cwat_permute          (:,:))                 
wetdepa_v2_para%precs                    = loc(precs_permute         (:,:))                 
wetdepa_v2_para%conds                    = loc(conds_permute         (:,:))                 
wetdepa_v2_para%evaps                    = loc(evaps_permute         (:,:))                 
wetdepa_v2_para%cldvcu                   = loc(cldvcu_permute        (:,:))                 
wetdepa_v2_para%cldvst                   = loc(cldvst_permute        (:,:))                 
wetdepa_v2_para%dlf                      = loc(dlf_permute           (:,:))                 
wetdepa_v2_para%tracer                   = loc(tracer_permute        (:,:))                 
wetdepa_v2_para%scavcoef                 = loc(scavcoef_permute      (:,:))                 
wetdepa_v2_para%sol_factic_in            = loc(sol_factic_in_permute (:,:))                 
                                                                    
wetdepa_v2_para%scavt                    = loc(scavt_permute         (:,:))                 
wetdepa_v2_para%iscavt                   = loc(iscavt_permute        (:,:))                 
wetdepa_v2_para%fracis                   = loc(fracis_permute        (:,:))                 
wetdepa_v2_para%icscavt                  = loc(icscavt_permute       (:,:))                 
wetdepa_v2_para%isscavt                  = loc(isscavt_permute       (:,:))                 
wetdepa_v2_para%bcscavt                  = loc(bcscavt_permute       (:,:))                 
wetdepa_v2_para%bsscavt                  = loc(bsscavt_permute       (:,:))                 

!call acc_transpose_c(p             , p_permute             , pcols, pver) 
!call acc_transpose_c(q             , q_permute             , pcols, pver) 
!call acc_transpose_c(pdel          , pdel_permute          , pcols, pver) 
!call acc_transpose_c(cldt          , cldt_permute          , pcols, pver) 
!call acc_transpose_c(cldc          , cldc_permute          , pcols, pver) 
!call acc_transpose_c(cmfdqr        , cmfdqr_permute        , pcols, pver) 
!call acc_transpose_c(evapc         , evapc_permute         , pcols, pver) 
!call acc_transpose_c(conicw        , conicw_permute        , pcols, pver) 
!call acc_transpose_c(cwat          , cwat_permute          , pcols, pver) 
!call acc_transpose_c(precs         , precs_permute         , pcols, pver) 
!call acc_transpose_c(conds         , conds_permute         , pcols, pver) 
!call acc_transpose_c(evaps         , evaps_permute         , pcols, pver) 
!call acc_transpose_c(cldvcu        , cldvcu_permute        , pcols, pver) 
!call acc_transpose_c(cldvst        , cldvst_permute        , pcols, pver) 
!call acc_transpose_c(dlf           , dlf_permute           , pcols, pver) 
!call acc_transpose_c(tracer        , tracer_permute        , pcols, pver) 
!call acc_transpose_c(scavcoef      , scavcoef_permute      , pcols, pver) 
!call acc_transpose_c(sol_factic_in , sol_factic_in_permute , pcols, pver) 
!call acc_transpose_c(scavt         , scavt_permute         , pcols, pver) 
!call acc_transpose_c(iscavt        , iscavt_permute        , pcols, pver) 
!call acc_transpose_c(fracis        , fracis_permute        , pcols, pver) 
!call acc_transpose_c(icscavt       , icscavt_permute       , pcols, pver) 
!call acc_transpose_c(isscavt       , isscavt_permute       , pcols, pver) 
!call acc_transpose_c(bcscavt       , bcscavt_permute       , pcols, pver) 
!call acc_transpose_c(bsscavt       , bsscavt_permute       , pcols, pver) 
!do k = 1, pver
!    do i = 1, pcols
!        p_permute             (k,i) =  p             (i,k)   
!        q_permute             (k,i) =  q             (i,k) 
!        pdel_permute          (k,i) =  pdel          (i,k) 
!        cldt_permute          (k,i) =  cldt          (i,k) 
!        cldc_permute          (k,i) =  cldc          (i,k) 
!        cmfdqr_permute        (k,i) =  cmfdqr        (i,k) 
!        evapc_permute         (k,i) =  evapc         (i,k) 
!        conicw_permute        (k,i) =  conicw        (i,k) 
!        cwat_permute          (k,i) =  cwat          (i,k) 
!        precs_permute         (k,i) =  precs         (i,k) 
!        conds_permute         (k,i) =  conds         (i,k) 
!        evaps_permute         (k,i) =  evaps         (i,k) 
!        cldvcu_permute        (k,i) =  cldvcu        (i,k) 
!        cldvst_permute        (k,i) =  cldvst        (i,k) 
!        dlf_permute           (k,i) =  dlf           (i,k) 
!        tracer_permute        (k,i) =  tracer        (i,k) 
!        scavcoef_permute      (k,i) =  scavcoef      (i,k) 
!        sol_factic_in_permute (k,i) =  sol_factic_in (i,k)
!        scavt_permute         (k,i) =  scavt         (i,k) 
!        iscavt_permute        (k,i) =  iscavt        (i,k) 
!        fracis_permute        (k,i) =  fracis        (i,k) 
!        icscavt_permute       (k,i) =  icscavt       (i,k) 
!        isscavt_permute       (k,i) =  isscavt       (i,k) 
!        bcscavt_permute       (k,i) =  bcscavt       (i,k) 
!        bsscavt_permute       (k,i) =  bsscavt       (i,k) 
!    end do
!end do
if (present(qqcw) .and. present(f_act_conv)) then
    wetdepa_v2_para%version = 1
    wetdepa_v2_para%qqcw                     = loc(qqcw_permute          (:,:))                 
    wetdepa_v2_para%f_act_conv               = loc(f_act_conv_permute    (:,:))                 
    !call acc_transpose_c(qqcw          , qqcw_permute          , pcols, pver) 
    !call acc_transpose_c(f_act_conv    , f_act_conv_permute    , pcols, pver) 
    !do k = 1, pver
    !    do i = 1, pcols
    !        qqcw_permute          (k,i) =  qqcw          (i,k) 
    !        f_act_conv_permute    (k,i) =  f_act_conv    (i,k) 
    !    enddo
    !enddo
else
    wetdepa_v2_para%version = 2
endif

transpose_para%version = wetdepa_v2_para%version
transpose_para%pcols = pcols
transpose_para%pver = pver

transpose_para%p                                = loc(p             (:,:))                 
transpose_para%q                                = loc(q             (:,:))                 
transpose_para%pdel                             = loc(pdel          (:,:))                 
transpose_para%cldt                             = loc(cldt          (:,:))                 
transpose_para%cldc                             = loc(cldc          (:,:))                 
transpose_para%cmfdqr                           = loc(cmfdqr        (:,:))                 
transpose_para%evapc                            = loc(evapc         (:,:))                 
transpose_para%conicw                           = loc(conicw        (:,:))                 
transpose_para%cwat                             = loc(cwat          (:,:))                 
transpose_para%precs                            = loc(precs         (:,:))                 
transpose_para%conds                            = loc(conds         (:,:))                 
transpose_para%evaps                            = loc(evaps         (:,:))                 
transpose_para%cldvcu                           = loc(cldvcu        (:,:))                 
transpose_para%cldvst                           = loc(cldvst        (:,:))                 
transpose_para%dlf                              = loc(dlf           (:,:))                 
transpose_para%tracer                           = loc(tracer        (:,:))                 
transpose_para%scavcoef                         = loc(scavcoef      (:,:))                 
transpose_para%sol_factic_in                    = loc(sol_factic_in (:,:))                 
transpose_para%scavt                            = loc(scavt         (:,:))                 
transpose_para%iscavt                           = loc(iscavt        (:,:))                 
transpose_para%fracis                           = loc(fracis        (:,:))                 
transpose_para%icscavt                          = loc(icscavt       (:,:))                 
transpose_para%isscavt                          = loc(isscavt       (:,:))                 
transpose_para%bcscavt                          = loc(bcscavt       (:,:))                 
transpose_para%bsscavt                          = loc(bsscavt       (:,:))                 
transpose_para%p_permute                        = loc(p_permute             (:,:))                 
transpose_para%q_permute                        = loc(q_permute             (:,:))                 
transpose_para%pdel_permute                     = loc(pdel_permute          (:,:))                 
transpose_para%cldt_permute                     = loc(cldt_permute          (:,:))                 
transpose_para%cldc_permute                     = loc(cldc_permute          (:,:))                 
transpose_para%cmfdqr_permute                   = loc(cmfdqr_permute        (:,:))                 
transpose_para%evapc_permute                    = loc(evapc_permute         (:,:))                 
transpose_para%conicw_permute                   = loc(conicw_permute        (:,:))                 
transpose_para%cwat_permute                     = loc(cwat_permute          (:,:))                 
transpose_para%precs_permute                    = loc(precs_permute         (:,:))                 
transpose_para%conds_permute                    = loc(conds_permute         (:,:))                 
transpose_para%evaps_permute                    = loc(evaps_permute         (:,:))                 
transpose_para%cldvcu_permute                   = loc(cldvcu_permute        (:,:))                 
transpose_para%cldvst_permute                   = loc(cldvst_permute        (:,:))                 
transpose_para%dlf_permute                      = loc(dlf_permute           (:,:))                 
transpose_para%tracer_permute                   = loc(tracer_permute        (:,:))                 
transpose_para%scavcoef_permute                 = loc(scavcoef_permute      (:,:))                 
transpose_para%sol_factic_in_permute            = loc(sol_factic_in_permute (:,:))                 
transpose_para%scavt_permute                    = loc(scavt_permute         (:,:))                 
transpose_para%iscavt_permute                   = loc(iscavt_permute        (:,:))                 
transpose_para%fracis_permute                   = loc(fracis_permute        (:,:))                 
transpose_para%icscavt_permute                  = loc(icscavt_permute       (:,:))                 
transpose_para%isscavt_permute                  = loc(isscavt_permute       (:,:))                 
transpose_para%bcscavt_permute                  = loc(bcscavt_permute       (:,:))                 
transpose_para%bsscavt_permute                  = loc(bsscavt_permute       (:,:))                 
transpose_para%qqcw                     = loc(qqcw                     (:,:))                 
transpose_para%f_act_conv               = loc(f_act_conv               (:,:))                 
transpose_para%qqcw_permute          = loc(qqcw_permute          (:,:))                 
transpose_para%f_act_conv_permute    = loc(f_act_conv_permute    (:,:))                 
call athread_spawn(slave_transpose_parallel, transpose_para)
call athread_join()
call athread_spawn(slave_wetdepa_v2_parallel, wetdepa_v2_para)
call athread_join()

transpose_para%version = 3
call athread_spawn(slave_transpose_parallel, transpose_para)
call athread_join()
!call acc_transpose_c(scavt_permute         ,   scavt       , pver, pcols) 
!call acc_transpose_c(iscavt_permute        ,  iscavt       , pver, pcols) 
!call acc_transpose_c(fracis_permute        ,  fracis       , pver, pcols) 
!call acc_transpose_c(icscavt_permute       , icscavt       , pver, pcols) 
!call acc_transpose_c(isscavt_permute       , isscavt       , pver, pcols) 
!call acc_transpose_c(bcscavt_permute       , bcscavt       , pver, pcols) 
!call acc_transpose_c(bsscavt_permute       , bsscavt       , pver, pcols) 
!do k = 1, pver
!    do i = 1, pcols
!          scavt       (i,k) =  scavt_permute         (k,i) 
!         iscavt       (i,k) =  iscavt_permute        (k,i) 
!         fracis       (i,k) =  fracis_permute        (k,i) 
!        icscavt       (i,k) =  icscavt_permute       (k,i) 
!        isscavt       (i,k) =  isscavt_permute       (k,i) 
!        bcscavt       (i,k) =  bcscavt_permute       (k,i) 
!        bsscavt       (i,k) =  bsscavt_permute       (k,i) 
!    end do
!end do
...
!do i=1,ncol
!    do k=1,pver
!            if ( abs(scavt  (i, k) - scavt_permute  (k, i)) / abs(scavt  (i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(scavt  (i, k) - scavt_permute  (k, i)) / abs(scavt  (i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "scavt  (i, k): ", scavt  (i, k), "scavt_permute  (k, i): ", scavt_permute  (k, i)
!            endif
!            if ( abs(iscavt (i, k) - iscavt_permute (k, i)) / abs(iscavt (i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(iscavt (i, k) - iscavt_permute (k, i)) / abs(iscavt (i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "iscavt (i, k): ", iscavt (i, k), "iscavt_permute (k, i): ", iscavt_permute (k, i)
!            endif
!            if ( abs(fracis (i, k) - fracis_permute (k, i)) / abs(fracis (i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(fracis (i, k) - fracis_permute (k, i)) / abs(fracis (i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "fracis (i, k): ", fracis (i, k), "fracis_permute (k, i): ", fracis_permute (k, i)
!            endif
!            if ( abs(icscavt(i, k) - icscavt_permute(k, i)) / abs(icscavt(i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(icscavt(i, k) - icscavt_permute(k, i)) / abs(icscavt(i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "icscavt(i, k): ", icscavt(i, k), "icscavt_permute(k, i): ", icscavt_permute(k, i)
!            endif
!            if ( abs(isscavt(i, k) - isscavt_permute(k, i)) / abs(isscavt(i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(isscavt(i, k) - isscavt_permute(k, i)) / abs(isscavt(i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "isscavt(i, k): ", isscavt(i, k), "isscavt_permute(k, i): ", isscavt_permute(k, i)
!            endif
!            if ( abs(bcscavt(i, k) - bcscavt_permute(k, i)) / abs(bcscavt(i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(bcscavt(i, k) - bcscavt_permute(k, i)) / abs(bcscavt(i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "bcscavt(i, k): ", bcscavt(i, k), "bcscavt_permute(k, i): ", bcscavt_permute(k, i)
!            endif
!            if ( abs(bsscavt(i, k) - bsscavt_permute(k, i)) / abs(bsscavt(i, k)) > 1e-10_r8 ) then
!                print*, "err:", abs(bsscavt(i, k) - bsscavt_permute(k, i)) / abs(bsscavt(i, k)), "i: ", i, "k: ", k, "pver: ", pver, "ncol: ", ncol, "pcols: ", pcols, "bsscavt(i, k): ", bsscavt(i, k), "bsscavt_permute(k, i): ", bsscavt_permute(k, i)
!            endif
!    enddo
!enddo
