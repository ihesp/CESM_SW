...
! allocate the individual state components
  ...
  type(assigninf_args) :: assigninf_para
  integer, external :: slave_assigninf_parallel
...
!<<<<<<< HEAD
  ...
  call t_startf('equal_inf_cpe')
  !assigninf_para%psetcols       = psetcols
  !assigninf_para%pver           = pver     
  !assigninf_para%pcnst          = pcnst    
  !assigninf_para%infr8          = inf
  !assigninf_para%lat            = loc(state%lat      (:))
  !assigninf_para%lon            = loc(state%lon      (:))
  !assigninf_para%ulat           = loc(state%ulat     (:))
  !assigninf_para%ulon           = loc(state%ulon     (:))
  !assigninf_para%ps             = loc(state%ps       (:))
  !assigninf_para%psdry          = loc(state%psdry    (:))
  !assigninf_para%phis           = loc(state%phis     (:))
  !assigninf_para%t              = loc(state%t        (:,:))
  !assigninf_para%u              = loc(state%u        (:,:))
  !assigninf_para%v              = loc(state%v        (:,:))
  !assigninf_para%s              = loc(state%s        (:,:))
  !assigninf_para%omega          = loc(state%omega    (:,:))
  !assigninf_para%pmid           = loc(state%pmid     (:,:))
  !assigninf_para%pmiddry        = loc(state%pmiddry  (:,:))
  !assigninf_para%pdel           = loc(state%pdel     (:,:))
  !assigninf_para%pdeldry        = loc(state%pdeldry  (:,:))
  !assigninf_para%rpdel          = loc(state%rpdel    (:,:))
  !assigninf_para%rpdeldry       = loc(state%rpdeldry (:,:))
  !assigninf_para%lnpmid         = loc(state%lnpmid   (:,:))
  !assigninf_para%lnpmiddry      = loc(state%lnpmiddry(:,:))
  !assigninf_para%exner          = loc(state%exner    (:,:))
  !assigninf_para%zm             = loc(state%zm       (:,:))
  !assigninf_para%q              = loc(state%q        (:,:,:))
  !assigninf_para%pint           = loc(state%pint     (:,:))
  !assigninf_para%pintdry        = loc(state%pintdry  (:,:))
  !assigninf_para%lnpint         = loc(state%lnpint   (:,:))
  !assigninf_para%lnpintdry      = loc(state%lnpintdry(:,:))
  !assigninf_para%zi             = loc(state%zi       (:,:))
  !assigninf_para%te_ini         = loc(state%te_ini   (:))
  !assigninf_para%te_cur         = loc(state%te_cur   (:))
  !assigninf_para%tw_ini         = loc(state%tw_ini   (:))
  !assigninf_para%tw_cur         = loc(state%tw_cur   (:))
  !call athread_spawn(slave_assigninf_parallel, assigninf_para)
  !call athread_join()
  call t_stopf('equal_inf_cpe')
