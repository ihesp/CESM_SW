...
subroutine micro_mg_utils_init( kind, rh2o, cpair, tmelt_in, latvap, &
  ...
  ! pgam dynamically.
  mg_liq_props = NewMGHydrometeorProps(rhow, dsph, &
  ...
  mg_ice_props = NewMGHydrometeorProps(rhoi, dsph, &
...
!  pure function rising_factorial(x, n)
  elemental pure function rising_factorial(x, n)
