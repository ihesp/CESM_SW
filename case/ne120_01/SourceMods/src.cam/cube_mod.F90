...
!GridEdge : changed its 'out' attribute to 'inout'
    ...
    ! do j = 1,ne / 2
    !    do i = 1,ne
    !       Mesh(i, j) = (j - 1) * 2 * ne + i - 1
    !       Mesh(i, ne - j + 1) = (j - 1) * 2 * ne + ne + i - 1
    !    end do
    ! end do
    ! -------------------------------------------
    ...
    do j=1,ne
       do i=1,ne
          GridElem(i,j,1)%SpaceCurve = ne * ne * 0 + Mesh(i,ne-j+1)
       enddo
    enddo
    ...
    do j=1,ne
       do i=1,ne
          GridElem(i,j,2)%SpaceCurve = ne * ne * 1 + Mesh(i,ne-j+1)
       enddo
    enddo
    ...
    do j=1,ne
       do i=1,ne
          GridElem(i,j,6)%SpaceCurve = ne * ne * 5 + Mesh(ne-i+1,ne-j+1)
       enddo
    enddo
    ...
    do j=1,ne
       do i=1,ne
          GridElem(i,j,4)%SpaceCurve = ne * ne * 3 + Mesh(ne-j+1,i)
       enddo
    enddo
    ...
    do j=1,ne
       do i=1,ne
          GridElem(i,j,5)%SpaceCurve = ne * ne * 4 + Mesh(i,j)
       enddo
    enddo
    ...
    do j=1,ne
       do i=1,ne
          GridElem(i,j,3)%SpaceCurve = ne * ne * 2 + Mesh(i,j)
       enddo
    enddo
