...
! Declarations for radiative transfer
      real(kind=r8), allocatable :: abscld(:,:)
      ...
      real(kind=r8), allocatable :: efclfrac(:,:)
      ...
      real(kind=r8), allocatable :: odcld(:,:)
...
! over a wide range of precipitable water values.
      ...
      allocate(abscld(nlayers,ngptlw), efclfrac(nlayers,ngptlw), odcld(nlayers,ngptlw))
