...
elemental function GoffGratch_svp_water(t) result(es)
  ...
  real(8) :: tmp, tmp1, tmp2, tmp3, tmp4, tmp5

  !tmp = tboil/t
  !tmp1 = log10(tmp)
  !tmp = 11.344_r8*(1._r8-t/tboil)
  !tmp2 = 10._r8**(tmp)
  !tmp = -3.49149_r8*(tboil/t-1._r8)
  !tmp3 = 10._r8**(tmp)
  !tmp4 = log10(1013.246_r8)
  !tmp = (-7.90298_r8*(tboil/t-1._r8)+ &
  !     5.02808_r8*tmp1- &
  !     1.3816e-7_r8*(tmp2-1._r8)+ &
  !     8.1328e-3_r8*(tmp3-1._r8)+ &
  !     tmp4)
