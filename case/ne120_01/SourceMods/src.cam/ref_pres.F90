...
real(r8) :: pref_edge(pverp)     ! Layer edges
real(r8) :: pref_mid(pver)       ! Layer midpoints
real(r8) :: pref_mid_norm(pver)  ! Layer midpoints normalized by
                                            ! surface pressure ('eta' coordinate)

real(r8) :: ptop_ref             ! Top of model
real(r8) :: psurf_ref            ! Surface pressure
