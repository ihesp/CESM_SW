...
interface 
pure subroutine transfer_r4_c(src, dst)
    integer(4), intent(in) :: src
    real(4), intent(out) :: dst
end subroutine
pure subroutine transfer_r8_c(src, dst)
...
#else
  if (nan%quiet) then
     call transfer_r4_c(sqnan_pat, output)
  else
     call transfer_r4_c(ssnan_pat, output)
  end if
#endif
...
#else
  if (inf%positive) then
     call transfer_r4_c(sposinf_pat, output)
  else
     call transfer_r4_c(sneginf_pat, output)
  end if
#endif
...
#else
  if (nan%quiet) then
     call transfer_r8_c(dqnan_pat, output)
  else
     call transfer_r8_c(dsnan_pat, output)
  end if
#endif
...
#else
  if (inf%positive) then
     call transfer_r8_c(dposinf_pat, output)
  else
     call transfer_r8_c(dneginf_pat, output)
  end if
#endif
