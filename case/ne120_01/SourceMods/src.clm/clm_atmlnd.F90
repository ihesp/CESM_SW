...
!----------------------------------------------------
  ...
  type(atm2lnd_downscaled_fields_type),public,target :: clm_a2l      ! a2l fields on clm grid
...
!  type(atm2lnd_downscaled_fields_type),public,pointer :: a2l_not_downscaled_gcell
