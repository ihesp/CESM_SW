...
subroutine cesm_pre_init1()
   ...
   call cesm_swlu_prof_init_withcomm(4, mpicom_CPLALLATMID)
   ...
   call cesm_swlu_prof_init_withcomm(5, mpicom_CPLALLOCNID)
...
subroutine cesm_pre_init2()
   ...
   integer :: maxthreads
   !integer, external :: slave_math_addr
   integer, external :: slave_setftz
   !----------------------------------------------------------
   ...
   call athread_init()
   !call athread_spawn(slave_math_addr, 0)
   !call athread_join()
...
!===============================================================================
 ...
 subroutine cesm_final()
   ...
   call cesm_swlu_prof_print(3)
   call cesm_swlu_prof_set_print_every(1)
   call cesm_swlu_prof_print(4)
   call cesm_swlu_prof_print(5)
   call cesm_swlu_prof_set_print_every(0)
