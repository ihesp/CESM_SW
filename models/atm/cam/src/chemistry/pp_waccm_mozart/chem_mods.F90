...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 88, & ! number of photolysis reactions
                            rxntot = 287, & ! number of total reactions
                            gascnt = 199, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 85, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 610, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 48, & ! number of species in implicit class
