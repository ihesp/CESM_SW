...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 114, & ! number of photolysis reactions
                            rxntot = 462, & ! number of total reactions
                            gascnt = 348, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 168, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1428, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 131, & ! number of species in implicit class
