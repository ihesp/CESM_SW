...
!-------------------------------------------------------
      ...
      rate(:,:,214) = 6.60E-11_r8
      rate(:,:,215) = 2.30E-12_r8
      rate(:,:,216) = 1.20E-11_r8
      rate(:,:,220) = 1.40E-11_r8
      rate(:,:,221) = 2.80E-11_r8
      rate(:,:,222) = 5.70E-11_r8
      rate(:,:,223) = 1.90E-12_r8
      rate(:,:,249) = 9.e-10_r8
      rate(:,:,250) = 1.0e-10_r8
      rate(:,:,251) = 4.4e-10_r8
      rate(:,:,252) = 4.0e-10_r8
      ...
      rate(:,:,185) = 1.20e-12_r8 * exp( -330._r8 * itemp(:,:) )
      ...
      rate(:,:,207) = 2.17e-11_r8 * exp( -1130._r8 * itemp(:,:) )
      rate(:,:,208) = 2.40e-12_r8 * exp( -1250._r8 * itemp(:,:) )
      rate(:,:,209) = 1.64e-12_r8 * exp( -1520._r8 * itemp(:,:) )
      rate(:,:,211) = 2.35e-12_r8 * exp( -1300._r8 * itemp(:,:) )
      rate(:,:,212) = 2.10E-11_r8 * exp( -2200.0_r8 * itemp(:,:) )
      rate(:,:,213) = 1.10E-13_r8 * exp( -1200.0_r8 * itemp(:,:) )
      rate(:,:,217) = 2.70E-11_r8 * exp( 335._r8 * itemp(:,:) )
      rate(:,:,218) = 1.25E-13_r8 * exp( -2190.0_r8 * itemp(:,:) )
      rate(:,:,219) = 3.40E-12_r8 * exp( -1100.0_r8 * itemp(:,:) )
      rate(:,:,227) = 9.60e-12_r8 * exp( -234._r8 * itemp(:,:) )
...
!-------------------------------------------------------
      ...
      rate(:,:kbot,250) = 1.0e-10_r8
      rate(:,:kbot,251) = 4.4e-10_r8
      rate(:,:kbot,252) = 4.0e-10_r8
      rate(:,:kbot,253) = 2.0e-10_r8
      rate(:,:kbot,254) = 1.0e-12_r8
      rate(:,:kbot,255) = 6.0e-11_r8
