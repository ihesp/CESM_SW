...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 83, & ! number of photolysis reactions
                            rxntot = 405, & ! number of total reactions
                            gascnt = 322, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 171, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1274, & ! number of non-zero matrix entries
                            extcnt = 9, & ! number of species with external forcing
                            clscnt1 = 29, & ! number of species in explicit class
                            clscnt2 = 0, & ! number of species in hov class
                            clscnt3 = 0, & ! number of species in ebi class
                            clscnt4 = 142, & ! number of species in implicit class
