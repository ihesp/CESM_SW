...
!-------------------------------------------------------
      ...
      rate(:,:,403) = 6.60E-11_r8
      rate(:,:,404) = 2.30E-12_r8
      rate(:,:,405) = 1.20E-11_r8
      rate(:,:,409) = 1.40E-11_r8
      rate(:,:,410) = 2.80E-11_r8
      rate(:,:,411) = 5.70E-11_r8
      rate(:,:,412) = 1.90E-12_r8
      rate(:,:,439) = 9.0e-10_r8
      rate(:,:,440) = 1.0e-10_r8
      rate(:,:,441) = 4.4e-10_r8
      rate(:,:,442) = 4.0e-10_r8
      ...
      rate(:,:,403) = 6.60E-11_r8 * exp_fac(:,:)
      rate(:,:,404) = 2.30E-12_r8 * exp_fac(:,:)
      rate(:,:,405) = 1.20E-11_r8 * exp_fac(:,:)
      rate(:,:,409) = 1.40E-11_r8 * exp_fac(:,:)
      rate(:,:,410) = 2.80E-11_r8 * exp_fac(:,:)
      rate(:,:,411) = 5.70E-11_r8 * exp_fac(:,:)
      rate(:,:,412) = 1.90E-12_r8 * exp_fac(:,:)
      rate(:,:,439) = 9.0e-10_r8 * exp_fac(:,:)
      rate(:,:,440) = 1.0e-10_r8 * exp_fac(:,:)
      rate(:,:,441) = 4.4e-10_r8 * exp_fac(:,:)
      rate(:,:,442) = 4.0e-10_r8 * exp_fac(:,:)
      rate(:,:,443) = 2.0e-10_r8 * exp_fac(:,:)
      rate(:,:,444) = 1.0e-12_r8 * exp_fac(:,:)
      rate(:,:,445) = 6.0e-11_r8 * exp_fac(:,:)
      rate(:,:,446) = 5.0e-16_r8 * exp_fac(:,:)
      ...
      rate(:,:,401) = 2.10E-11_r8 * exp( -2200.0_r8 * itemp(:,:) )
      rate(:,:,402) = 1.10E-13_r8 * exp( -1200.0_r8 * itemp(:,:) )
      rate(:,:,406) = 2.70E-11_r8 * exp( 335._r8 * itemp(:,:) )
      rate(:,:,407) = 1.25E-13_r8 * exp( -2190.0_r8 * itemp(:,:) )
      rate(:,:,408) = 3.40E-12_r8 * exp( -1100.0_r8 * itemp(:,:) )
      rate(:,:,415) = 9.60e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,417) = 1.90e-13_r8 * exp( 520._r8 * itemp(:,:) )
...
!-------------------------------------------------------
      ...
      rate(:,:kbot,440) = 1.0e-10_r8
      rate(:,:kbot,441) = 4.4e-10_r8
      rate(:,:kbot,442) = 4.0e-10_r8
      rate(:,:kbot,443) = 2.0e-10_r8
      rate(:,:kbot,444) = 1.0e-12_r8
      rate(:,:kbot,445) = 6.0e-11_r8
