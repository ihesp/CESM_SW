...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 44, & ! number of photolysis reactions
                            rxntot = 245, & ! number of total reactions
                            gascnt = 201, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 130, & ! number of "gas phase" species
                            nfs = 4, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 979, & ! number of non-zero matrix entries
